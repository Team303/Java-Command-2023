...
import com.team303.swervelib.DriveController;
import com.team303.swervelib.DriveControllerFactory;
...
public final class NeoDriveControllerFactoryBuilder {
    ...
    private class FactoryImplementation implements DriveControllerFactory<ControllerImplementation, Integer> {
        ...
        public ControllerImplementation create(Integer id, String _canbus, MechanicalConfiguration mechConfiguration) {
            ...
            double positionConversionFactor = Math.PI * mechConfiguration.getWheelDiameter()
